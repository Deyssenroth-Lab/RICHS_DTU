...
catVars <- c("Gender", "BWgroup", "Delivery", "Momrace","Parity","Batch.MoBT")
...
```
    ...
    ##                           level            AGA              SGA             
    ##   n                                            112               30         
    ##   BWgroup (%)             AGA                  112 (100.0)        0 (  0.0) 
    ##                           SGA                    0 (  0.0)       30 (100.0) 
    ##   BWgrams (mean (SD))                      3436.77 (388.87) 2581.17 (288.13)
    ##   Gender (%)              Male                  55 ( 49.1)       10 ( 33.3) 
    ##                           Female                57 ( 50.9)       20 ( 66.7) 
    ##   Momage (mean (SD))                         31.14 (4.61)     32.47 (5.44)  
    ##   Momrace (%)             White                 91 ( 81.2)       17 ( 56.7) 
    ##                           Black                  2 (  1.8)        6 ( 20.0) 
    ##                           Other                 19 ( 17.0)        7 ( 23.3) 
    ##   BMI (mean (SD))                            25.58 (5.85)     26.03 (7.27)  
    ##   Parity (%)              0                     40 ( 36.0)       16 ( 53.3) 
    ##                           1                     71 ( 64.0)       14 ( 46.7) 
    ##   GAweeks (mean (SD))                        39.07 (0.93)     38.90 (1.21)  
    ##   Delivery (%)            Vaginal               65 ( 58.0)       18 ( 60.0) 
    ##                           Cesarian Section      47 ( 42.0)       12 ( 40.0) 
    ##   As.MoBT (mean (SD))                         0.04 (0.03)      0.07 (0.08)  
    ##   Cd.MoBT (mean (SD))                         0.02 (0.02)      0.01 (0.01)  
    ##   Batch.MoBT (%)          1                     11 ( 11.2)        8 ( 29.6) 
    ##                           2                     13 ( 13.3)        6 ( 22.2) 
    ##                           3                      4 (  4.1)        3 ( 11.1) 
    ##                           4                     24 ( 24.5)        4 ( 14.8) 
    ##                           5                     18 ( 18.4)        2 (  7.4) 
    ##                           6                     28 ( 28.6)        4 ( 14.8) 
    ##   As.MoBT_log (mean (SD))                    -3.31 (0.63)     -3.01 (0.74)  
    ##   Cd.MoBT_log (mean (SD))                    -4.59 (1.01)     -4.52 (0.75)  
    ##                          Stratified by BWgroup
    ##                           p      test
    ##   n                                  
    ##   BWgroup (%)             <0.001     
    ##                                      
    ##   BWgrams (mean (SD))     <0.001     
    ##   Gender (%)               0.182     
    ##                                      
    ##   Momage (mean (SD))       0.181     
    ##   Momrace (%)             <0.001     
    ##                                      
    ##                                      
    ##   BMI (mean (SD))          0.721     
    ##   Parity (%)               0.132     
    ##                                      
    ##   GAweeks (mean (SD))      0.403     
    ##   Delivery (%)             1.000     
    ##                                      
    ##   As.MoBT (mean (SD))      0.023     
    ##   Cd.MoBT (mean (SD))      0.674     
    ##   Batch.MoBT (%)           0.039     
    ##                                      
    ##                                      
    ##                                      
    ##                                      
    ##                                      
    ##   As.MoBT_log (mean (SD))  0.035     
    ##   Cd.MoBT_log (mean (SD))  0.749
...
for (i in 1:nrow(top.genes))
{
  ...
  pdf(paste0("SGA/Plots/d_SGA_",top.genes$hgnc_symbol[i],".pdf"))  
  print(plotProportions(d_SGA, gene_id=top_gene_id, group_variable ="group",group_colors=c("black","mediumorchid1"),plot_type = "boxplot1"))
  dev.off()
}
```
